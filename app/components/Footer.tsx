...
const Footer = () => {
  return (
    <div className="w-full h-188.75  bg-gray-200 pt-25">
      <div className="w-full h-25 bg-[#50c878] flex gap-8.5 text-[30px] font-semibold text-white justify-center items-center">
      ...
      <div className="flex gap-55 container items-start py-20 ">
        <div className="flex flex-col items-center gap-3  justify-center">
          ...
          <div>
            <p className="text-[20px] font-semibold text-white">
              Nom
              <span className="text-[20px] font-semibold text-[#50c878]">
                Nom
              </span>
            </p>
            <p>Swift delivery</p>
        ...
        <div className="flex gap-28">
          <div className=" space-y-4">
            <p className="text-[16px] text-[#4d4d51]">NOMNOM</p>
            <p className="text-[16px] ">Home</p>
            <p className="text-[16px] ">Contact us</p>
            <p className="text-[16px] ">Delivery zone</p>
          </div>
          <div className="flex gap-14">
            <div className=" space-y-4">
              <p className="text-[16px] text-[#4d4d51]">MENU</p>
              <p className="text-[16px] ">Appetizers</p>
              <p className="text-[16px] ">Salads</p>
              <p className="text-[16px] ">Pizzas</p>
              <p className="text-[16px] ">Main dishes</p>
              <p className="text-[16px] ">Desserts</p>
            </div>
            <div className=" space-y-4">
              <p className="text-[16px] ">Side dish </p>
              <p className="text-[16px] ">Brunch</p>
              <p className="text-[16px] ">Desserts</p>
              <p className="text-[16px] ">Beverages</p>
              <p className="text-[16px] ">Fish & Sea foods</p>
            </div>
          </div>
          <div>
            <div className=" space-y-4">
              <p className="text-[16px] text-[#4d4d51]">FOLLOW US</p>
      ...
      <div className="border-t container border-[#707072] flex space-x-12 py-8">
        <p className="text-[14px] text-[#707072]">
          Copy right 2024 © Nomnom LLC
        </p>
        <p className="text-[14px] text-[#707072]">Privacy policy </p>
        <p className="text-[14px] text-[#707072]">Terms and conditoin </p>
        <p className="text-[14px] text-[#707072]">Cookie policy </p>
      </div>
    </div>
  );
};
